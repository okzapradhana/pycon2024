...
with DAG(
    dag_id='csv2postgre_candy_products',
    description='Sequence of jobs to ingest CSV files to candy_products in Postgres. This DAG is created through generator script.',
    ...
    extract_csv = PythonOperator(
        ...
        op_args=[os.path.join(os.environ.get('AIRFLOW_HOME'), 'datasource', 'candy_products.csv')]
    )
