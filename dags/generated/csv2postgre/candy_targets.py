...
with DAG(
    dag_id='csv2postgre_candy_targets',
    description='Sequence of jobs to ingest CSV files to candy_targets in Postgres. This DAG is created through generator script.',
    ...
    extract_csv = PythonOperator(
        ...
        op_args=[os.path.join(os.environ.get('AIRFLOW_HOME'), 'datasource', 'candy_targets.csv')]
    )
